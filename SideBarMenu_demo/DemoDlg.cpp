...
BOOL CDemoDlg::OnInitDialog()
{
	...
	mnuSideBar.SetSideBarText("Side Bar");
	...
	mnuSideBarSubmenu.CreatePopupMenu();
    mnuSideBarSubmenu.AppendMenu(MF_STRING|MF_OWNERDRAW,20,"Item 1 - submenu");
    mnuSideBarSubmenu.AppendMenu(MF_STRING|MF_OWNERDRAW,21,"Item 2 - submenu");
    mnuSideBarSubmenu.AppendMenu(MF_STRING|MF_OWNERDRAW,22,"Item 3 - submenu");
    mnuSideBarSubmenu.AppendMenu(MF_STRING|MF_OWNERDRAW,23,"Item 4 - submenu");
    mnuSideBar.AppendMenu(MF_POPUP|MF_OWNERDRAW,(UINT)mnuSideBarSubmenu.GetSafeHmenu(),"Sub Menu");
...
ULONG CDemoDlg::GetGestureStatus(CPoint ptTouch)
{
	return 0;
}
